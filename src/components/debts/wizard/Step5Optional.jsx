...
export default function Step5Optional({ formData, updateFormData }) {
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold">Bijna klaar! Nog wat optionele details.</h2>
      <p className="text-muted-foreground">Deze gegevens maken je administratie compleet, maar zijn niet verplicht.</p>
      
      <div className="space-y-2">
        <Label htmlFor="case_number">Dossiernummer</Label>
        <Input
          id="case_number"
      ...
      <Accordion type="multiple" className="w-full">
        <AccordionItem value="payment_details">
          <AccordionTrigger>Betaalgegevens</AccordionTrigger>
          <AccordionContent className="space-y-4 pt-2">
            <div className="space-y-2">
              <Label htmlFor="payment_iban">IBAN Rekeningnummer</Label>
              <Input
                id="payment_iban"
            ...
            <div className="space-y-2">
              <Label htmlFor="payment_account_name">Ten name van</Label>
              <Input
        ...
        <AccordionItem value="contact">
          <AccordionTrigger>Contactpersoon</AccordionTrigger>
          <AccordionContent className="space-y-4 pt-2">
            <div className="space-y-2">
              <Label htmlFor="contact_person_name">Naam contactpersoon</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="contact_person_details">Contactgegevens (tel/mail)</Label>
              <Input
        ...
        <AccordionItem value="notes">
          <AccordionTrigger>Notities</AccordionTrigger>
